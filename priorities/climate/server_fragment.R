...
output$licensed_ulev_plot <- renderGirafe({
  gg <- ggplot(df_licensed_ulev,
    ...
    labs(title = "Proportion of Ultra Low Emission Vehicles",
         ...
         y = "Percentage",
         fill = NULL,
         alt = "Line chart showing the proportion of licensed vehicles registered to Trafford addresses which are ultra low emission vehicles has been consistently lower, and increasing at a slower rate, compared to the average for similar authorities and England across the 3 year period shown. At the end of June 2023 the average proportion for similar authorities was 7.15% compared with an average of 3.44% in England and 2.54% in Trafford.") +
    theme_x()
...
output$ev_charging_points_plot <- renderGirafe({
  gg <- ggplot(df_ev_charging_points_rate,
    ...
    labs(title = "Publicly available electric vehicle charging devices",
         ...
         y = "Devices (per 100K)",
         fill = NULL,
         alt = "Line chart showing that there have been consistently fewer publicly available charging devices per 100,000 people in Trafford compared to the average of similar authorities and England between January 2021 and October 2023. The number of devices per 100,000 people in Trafford is increasing at a slightly slower rate than its comparitors, however the increases between quarters have been much more consistent since October 2022. The latest data for October 2023 of 49.2 devices per 100,000 population is still much lower compared to 66.7 for the average of similar authorities and 75.2 for England.") +
    theme_x()
...
df_epc <- bind_rows(calc10YearProportionEPC("2011-03-31", "2020-12-31"),
