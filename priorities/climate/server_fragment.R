...
output$licensed_vehicles_plot <- renderggiraph({
  gg <- ggplot(df_licensed_vehicles,
               ...
               labs(title = "All Licensed vehicles",
                    ...
                    y = "Count",
                    fill = NULL,
                    alt = "Line chart showing the number of vehicles registered to Trafford addresses has been consistently lower compared to the average of similar authorities over the 3 year period shown. The numbers in Trafford for each calendar quarter are consistently around 130,000. The average for similar authorities has been much higher compared to Trafford, with around 200,000 - 205,000 licensed vehicles each calendar quarter since the end of September 2020. The latest data for the end of March 2023 shows 130,503 vehicles registered within Trafford compared with an average of 201,382 vehicles in similar authorities.") +
               theme_x()
...
output$licensed_ulev_plot <- renderggiraph({
  gg <- ggplot(df_licensed_ulev,
    ...
    labs(title = "Proportion of Ultra Low Emission Vehicles",
         ...
         y = "Percentage",
         fill = NULL,
         alt = "Line chart showing the proportion of licensed vehicles registered to Trafford addresses which are ultra low emission vehicles has been consistently lower, and increasing at a slower rate, compared to the average for similar authorities and England across the 3 year period show. At the end of March 2023 the average proportion for similar authorities was 6.63% compared with an average of 3.18% in England and 2.31% in Trafford.") +
    theme_x()
...
output$ev_charging_points_plot <- renderggiraph({
  gg <- ggplot(df_ev_charging_points_rate,
    ...
    labs(title = "Publicly available electric vehicle charging devices",
         ...
         y = "Devices (per 100K)",
         fill = NULL,
         alt = "Line chart showing that there have been consistently fewer publicly available charging devices per 100,000 people in Trafford compared to the average of similar authorities and England between October 2020 and July 2023. The number of devices per 100,000 people in Trafford is increasing at a slightly slower rate than its comparitors, however the increases between quarters have been much more consistent since October 2022. The latest data for July 2023 of 43.7 devices per 100,000 population is still much lower compared to 60.1 for the average of similar authorities and 66.7 for England.") +
    theme_x()
...
df_epc <- bind_rows(calc10YearProportionEPC("2010-12-31", "2020-09-30"),
...
output$no2_concentration_plot <- renderggiraph({
  gg <- ggplot(df_no2_concentration,
    ...
    labs(title = expression(paste("Annual mean Nitrogen Dioxide (", NO[2], ") concentration")),
         ...
         fill = NULL,
         colour = "Location: ",
         alt = "Line chart showing the annual mean of N.O.2 readings taken between the 12 months ending June 2020 and the 12 months ending March 2023 at 3 monitoring stations within Trafford: Trafford A56, Trafford Moss Park and Trafford Wellacre Academy. Readings from Trafford A56 are the highest, followed by Trafford Moss Park and then Trafford Wellacre Academy. The latest annual mean recording of 10.7 microgrammes of N.O.2 per cubic metre at Trafford Wellacre Academy for the 12 months up to the end of March 2023 is the lowest recorded at this station during the time period shown. The latest annual mean recorded at Trafford Moss Park of 14.1 microgrammes of N.O.2 per cubic metre is only slightly above the lowest recording at this station during the period shown of 14 microgrammes of N.O.2 per cubic metre in the 12 months ending December 2020. Readings from Trafford A56 are on a slight upward trend since the lowest recorded annual mean at this station during the period shown of 21 microgrammes of N.O.2 per cubic metre in the 12 months ending December 2020. The latest annual mean is 24.1 microgrammes of N.O.2 per cubic metre.") +
    theme_x() +
    theme(
      legend.position = "top",
...
output$pm10_concentration_plot <- renderggiraph({
  gg <- ggplot(df_pm10_concentration,
    ...
    labs(title = expression(paste("Annual mean Particulate Matter (", PM[10], ") concentration")),
         ...
         fill = NULL,
         colour = "Location: ",
         alt = "Line chart showing the annual mean of PM10 readings taken between the 12 months ending June 2020 and the 12 months ending March 2023 at 2 monitoring stations within Trafford: Trafford A56 and Trafford Moss Park. Usually the annual mean recorded at Trafford A56 is higher than that at Trafford Moss Park, however for the latest 4 periods shown this trend has been reversed. The latest data shows an annual mean recording of 14.2 microgrammes of PM10 per cubic metre at Trafford A56 compared to 15 microgrammes at Trafford Moss Park, a decrease of 1.7 and 2 microgrammes per metre respectively from the previous 12 months annual mean.") +
    theme_x() +
    theme(
      legend.position = "top",
      legend.title = element_text(size = 9),
...
output$adults_walk_cycle_plot <- renderggiraph({
  gg <- ggplot(df_adults_walk_cycle,
    ...
    labs(title = "Adults walking or cycling five times per week",
         ...
         y = "Percentage",
         fill = NULL,
         alt = "Line chart showing the percentage of adults in Trafford regularly participating in walking or cycling activities (5 times per week) compared with the average of similar authorities and England from 2015-16 to 2020-21. Up to 2018-19 participation in Trafford was between 0.5 and 1 percentage points lower than the average of similar authorities and around 2 percentage points lower than the England average. 2019-20 showed a sharper participation increase in Trafford coupled with a decrease in its comparitors closing the gap, with both Trafford and the England average recording 34.5% participation compared with 34.3% for the average of similar authorities. However, the latest data for 2022-21 shows decreases in participation from the previous year in Trafford and its comparitors, to their respective lowest levels for the data shown: 30% in Trafford, 32.5% for the average of similar authorities and 33.6% for the England average.") +
    theme_x()
