  ...
  if (input$employment_rate_selection == "Trend") {
    ...
    gg <- ggplot(
      ...
      labs(
        ...
        y = "Percentage",
        colour = NULL,
        alt = "Line chart showing the employment rate amongst those aged 16 to 64 in Trafford compared to the average of similar authorities and England between the 12 months ending June 2011 and the 12 months ending June 2022. The average for similar authorities to Trafford and England follow a broadly similar trend with the England rate approximately between 1 and 2 percentage points below. From June 2015 to June 18 and in June 2020 Trafford was above the average of similar local authorities and England and Trafford was slightly below the average of local authorities in the 12 month ending June 2019 and the 12 month ending June 2021. However in June 2022 Trafford has fall 2.2 % below England rate and 4.8% below the average of similar local authorities at 73.5%"
      ) +
      theme_x()
  }
